 ...
 * @returns {String}
 */
function uint8ArrayToString(arr: Uint8Array, offset = 0, limit: number) {
 ...
 */
function identifyBoundary(header: string) {
 ...
 */
function containsToken(message: Uint8Array, token: Uint8Array, offset = 0) {
 ...
 */
function findToken(message: Uint8Array, token: Uint8Array, offset = 0, maxSearchLength?: number) {
 ...
 *
 * @param {Buffer} response Data encoded as a 'multipart/related' message
 * @returns {Array} The content
 */
function multipartDecode(response: Buffer) {
